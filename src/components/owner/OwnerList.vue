  ...
  <div>
    <b-row>
      <b-col
        md="2"
        offset-md="10">
        <RouterLink :to="{ name: 'OwnerCreate'}" >Create owner</RouterLink>
      </b-col>
    </b-row>
    <br>
    <b-row>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <owner-list-row
                ...
                :key="owner.id" :owner="owner" @details="detailsOwner" @update="updateOwner" @delete="deleteOwner" />
            </tbody>
          </table>
        </div>
      </b-col>
...
import OwnerListRow from './OwnerListRow'

export default {
  components: { OwnerListRow },
  name: 'OwnerList',
  data () {
    return {
      owners: [],
